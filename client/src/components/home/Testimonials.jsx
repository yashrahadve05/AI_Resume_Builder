...
const Testimonials = () => {
    ...
    return (
        <>
            <section className="flex flex-col items-center px-6 md:px-16 lg:px-24 text-sm max-w-6xl mx-auto mt-16">
                <div className="flex items-center mr-auto gap-2 text-indigo-600 bg-indigo-50 rounded-full px-3 py-1 mx-auto">
                ...
                <h1
                    className="text-3xl font-medium bg-linear-to-r from-slate-800 to-slate-500 text-transparent bg-clip-text mt-4">
                    Don't just take our words
                </h1>
                <p className="text-slate-500 mt-4 max-w-2xl text-center">
                ...
                <div className="marquee-row w-full mx-auto max-w-5xl overflow-hidden relative">
                    <div className="absolute left-0 top-0 h-full w-20 z-10 pointer-events-none bg-linear-to-r from-white to-transparent"></div>
                    <div className="marquee-inner-testimonials marquee-reverse flex transform-gpu min-w-[200%] pt-10 pb-5">
                        {[...cardsData, ...cardsData].map((card, index) => (
                            <CreateCard key={index} card={card} />
                        ))}
                    </div>
